...
Test::OpenTracing::Interface::SpanContext - compliance testing

=head1 SYNOPSIS

    use Test::OpenTracing::Interface::SpanContext qw/:all/;
    
    can_all_ok 'MyImplementation::SpanContext',
        "MyImplementation class does have all subs defined, well done!";
    
    my $test_thing = MyImplementation::SpanContext->new ( ... );
...
Test that all methods mentioned in L<OpenTracing::Interface::SpanContext>
are defined.
